package com.zjut.down.comment.dao.impl;
...
import com.zjut.down.comment.dao.Comment;
import com.zjut.down.comment.dao.CommentId;
import com.zjut.down.comment.dao.ICommentDAO;
 ...
 * 
 * @see com.zjut.down.comment.dao.Comment
...
public class CommentDAO extends HibernateDaoSupport implements ICommentDAO {
	...
	public static final String CMTDETAIL = "cmtdetail";
	...
	public Comment findById(com.zjut.down.comment.dao.CommentId id) {
		log.debug("getting Comment instance with id: " + id);
		try {
			Comment instance = (Comment) getHibernateTemplate().get(
					"com.zjut.down.comment.dao.Comment", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByCmtdetail(Object cmtdetail) {
		return findByProperty(CMTDETAIL, cmtdetail);
	}
